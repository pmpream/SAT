...
$sql = "SELECT * FROM employees ORDER BY status_ ASC";
...
<body>
    ...
    <hr>
    <?php if($count>0){?>
    <form action="search1.php" class="form-group" method="POST">
        <label for="">ค้นหาสถานะสัตว์</label>
        <input type="text" placeholder="ค้นหาสถานะสัตว์" name="status_" class="form-control">
    ...
    <table class="table table-bordered">
        ...
        <?php while($row=mysqli_fetch_assoc($result)){?>
            <tr>
                ...
                <td>
                <a href="editForm.php?id=<?php echo $row["id"]?>" class="btn btn-primary">Edit</a>
                </td>
                <td>
